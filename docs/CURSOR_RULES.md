...
- keep Cursor focused on planning when Cursor is the current primary assistant
...
- Do not add rules that let Cursor silently take over the secondary execution role without an explicit human reassignment.
